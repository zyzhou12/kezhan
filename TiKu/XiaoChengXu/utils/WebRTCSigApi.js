...
//test
const sdkappid = 1400127140;
const userid = 'userid_947645165_1';
const roomid = 12345678;
const accountType = 12354;

//读取私钥的内容
//PS:不要把私钥文件暴露到外网直接下载了哦
let privateKey = fs.readFileSync(path.resolve(__dirname, './key/private_key'));
let publicKey = fs.readFileSync(path.resolve(__dirname, './key/public_key'));
