...
namespace TiKu.Dal
{
  public class tPaperTypeDal
  {
    public static int Modify(IList<tPaperTypeEntity> objList, string doType,
        string updateFiels, string unupdateFiels)
    {
      string xmlData = PubFun.EntityListToXml(objList, "tPaperType", "DataSet",
      ...
      DBHelper.ProcRstInfo rst = DBHelper.ExecuteProc("TiKu", "tPaperType_Modify",
    ...
    public static int Delete(string ids)
    {
      ...
      using (XmlWriter xw = XmlWriter.Create(bufXml))
      {
        ...
        PubFun.WriteIDListToXml(xw, ids, "tPaperType", "tPaperTypeID");
    ...
    public static tPaperTypeEntity GettPaperType(int id)
    {
      tPaperTypeEntity rst = null;
      string strSQL = "SELECT * FROM tPaperType WHERE tPaperTypeID=" + id.ToString();
      DataTable dt = DBHelper.QueryToTable("TiKu", strSQL);
      if (dt.Rows.Count > 0)
      {
        rst = new tPaperTypeEntity();
        Trip8H.Common.PubFun.DataRowToObject(dt.Rows[0], rst);
      }
      return rst;
    }

    public static List<tPaperTypeEntity> GettPaperTypeList(int id)
    {
      StringBuilder bufSQL = new StringBuilder();
      List<DbParameter> lstParam = new List<DbParameter>();

      bufSQL.Append("SELECT * FROM tPaperType WHERE (1=1) ");

      if (id > 0)
      {
        bufSQL.Append(" AND tPaperTypeID=@id ");
      ...
      List<tPaperTypeEntity> lstRst = PubFun.DataTableToObjects<tPaperTypeEntity>(dtRst);
      return lstRst;
    }
